...
<html>
	<head>
		...
		$(function(){
		$('#yzm').click(function(){
		$(this).attr("src","${pageContext.request.contextPath}/anquan/yanzhengma.do?date="+new Date().getTime());
		...
		$("#sub").click(function(){
			$.ajax({
				...
				type:'post',
				data:{name:$('#un').val(),password:$('#pb').val()},
				...
				<div id="content">
					...
					<form id="form"  >
						<table cellpadding="0" cellspacing="0" border="0"
							...
							<tr>
								<td valign="middle" align="right">
									<img id="yzm" src="${pageContext.request.contextPath}/anquan/yanzhengma.do" />
								</td>
								<td valign="middle" align="left">
						...
						<p>
							<input type="submit" id="sub" class="button" value="Submit &raquo;" />
						</p>
					</form>
				</div>
			</div>
