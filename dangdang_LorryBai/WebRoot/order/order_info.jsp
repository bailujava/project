...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="../css/page_bottom.css" rel="stylesheet" type="text/css" />
				<script type="textx/javaScript" src="/js/jquery-1.8.3.js"></script>
	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
				<s:iterator value="#session.cart.shop">
					<tr>
						<td valign="top">
						...
						<td valign="top">
							<s:property value="value.book.dd_price"/>
						</td>
						<td valign="top">
							<s:property value="value.count"/>
						</td>
						<td valign="top">
							<s:property value="value.count*value.book.dd_price"/>
						</td>
					</tr>
				...
				<tr>
					<td valign="top" class="w1" style="text-align: left" colspan="5">
						...
						<b>总价￥<s:iterator value="#session.cart.total"/></b>
					</td>
				</tr>
			</table>
			<br />
			...
			<div class="login_in">
				...
				<a href="${pageContext.request.contextPath}/order/address"><input id="btnClientRegister" class="button_1" name="submit"
