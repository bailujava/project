...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="${pageContext.request.contextPath}/user/RegisterAction" id="f">
				<h2>
					以下均为必填项
				</h2>
				<table class="tab_login" >
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="${pageContext.request.contextPath}/user/useraction" />
